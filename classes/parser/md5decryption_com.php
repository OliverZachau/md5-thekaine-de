...
class md5decryption_com implements Parser
{
    var $Algorithm;
    var $HashCode;
    ...
    {
        $match_amount = preg_match_all('%(?<=Decrypted Text: </b>)(.*)(?=</font><br/><center>)%', $data, $matches);
    ...
    public function getCurl()
    {
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, array("hash" => $this->HashCode, "submit" => "Decrypt It!"));
