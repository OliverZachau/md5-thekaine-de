...
class netmd5crack_com implements Parser
{
    var $Algorithm;
    var $HashCode;
    ...
    public function parse($data)
    {
        ...
        $match_amount = preg_match_all('%(?<=</td><td class="border">)(.*)(?=</td></tr></table>)%', $data, $matches);
        return $match_amount > 0 && $matches[0][0] != "Sorry, we don't have that hash in our database." ? $matches[0][0] : "";
    }
    ...
    public function getCurl()
    {
        ...
        curl_setopt($ch, CURLOPT_URL, "http://www.netmd5crack.com/cgi-bin/Crack.py?InputHash={$this->HashCode}");
