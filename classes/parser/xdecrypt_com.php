...
class xdecrypt_com implements Parser
{
    var $Algorithm;
    var $HashCode;
    ...
    public function parse($data)
    {
        ...
        $match_amount = preg_match_all('%(?<=\(' . $algo . '\)=)(.*)(?= ")%', $data, $matches);
    ...
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "http://xdecrypt.com/ajax/liste.php?hash=x{$this->HashCode}x&_=1341489068480");
