...
class md5_hashcracking_com implements Parser
{
    var $Algorithm;
    var $HashCode;
    ...
    {
        $match_amount = preg_match_all('%(?<=is )(.*)%', $data, $matches);
    ...
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "http://md5.hashcracking.com/search.php?md5={$this->HashCode}");
