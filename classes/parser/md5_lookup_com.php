...
class md5_lookup_com implements Parser
{
    var $Algorithm;
    var $HashCode;
    ...
    public function parse($data)
    {
        ...
        $match_amount = preg_match_all('%(?<=<td width="250">)(.*)(?=</td>)%', $data, $matches);
    ...
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "http://www.md5-lookup.com/livesearch.php?q={$this->HashCode}");
